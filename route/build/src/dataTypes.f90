...
implicit none
 ...
 type, public :: runoff
   ...
   real(dp)                 , allocatable  :: simSub(:)        ! flux simulation (HM_HRU) at one time step (size: nSpace(1))
   real(dp)                 , allocatable  :: sim2D(:,:)    ! flux simulation (x,y) at one time step (size: /nSpace(1),nSpace(2)/)
   real(dp)                 , allocatable  :: sim2DSub(:,:)    ! flux simulation (x,y) at one time step (size: /nSpace(1),nSpace(2)/)
   ...
   real(dp)                 , allocatable  :: basinSubRunoff(:)! remapped river network catchment runoff (size: number of nHRU)
 ...
 type, public ::  RCHPRP
  ...
  real(dp)                                   :: D03_MinStorage ! Doll 2003; maximume storage [m3]
