module globalData
  ...
  real(dp)                       , public :: subfshape                     ! shape parameter in time delay histogram (=gamma distribution) [-]
  real(dp)                       , public :: subtscale                     ! scaling factor for the time delay histogram [sec]
  ...
  REAL(DP)        , allocatable  , public :: FRAC_FUTURE_SUB(:)   ! fraction of runoff in future time steps  
  ...
  TYPE(STRFLX)    , allocatable  , public :: RCHFLX_SUB(:,:)      ! Reach fluxes for subbasin runoff
  ...
  real(dp)        , allocatable  , public :: basinSubRunoff_trib(:)  ! HRU subsurface runoff array (m/s) for tributaries
  real(dp)        , allocatable  , public :: basinSubRunoff_main(:)  ! HRU subsurface runoff array (m/s) for mainstem  
