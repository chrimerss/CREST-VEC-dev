MODULE process_remap_module
  ...
  SUBROUTINE sort_flux  (ID_in,            & ! input: the array of ids for HRU/seg
                         ...
                         flag_nonzero,     & ! input: whether to treat non negative fluxes (used to distinguish runoff_data and wm_data)
  ...
  logical              , intent(in)    :: flag_nonzero        ! input: a flag value to determine whether treat non-negative values
  ! input/output
