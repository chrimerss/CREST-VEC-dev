module public_var
  ...
  integer(i4b)         ,public    :: doesSubSurfRoute     = 0               ! basin routing options   0-> no, 1->IRF, otherwise error
  ...
  character(len=strLen),public    :: vname_subqsim        = ''              ! variable name for simulated runoff
